...
void ArcballCamera::getEyeCoordinateSystem(glm::vec3& xAxis, glm::vec3& yAxis, glm::vec3& zAxis, glm::vec3& eye) const
{
	xAxis = glm::vec3(inv_camera[0][0], inv_camera[0][1], inv_camera[0][2]);
	yAxis = glm::vec3(inv_camera[1][0], inv_camera[1][1], inv_camera[1][2]);
	zAxis = glm::vec3(inv_camera[2][0], inv_camera[2][1], inv_camera[2][2]);
	eye = glm::vec3(inv_camera[3][0], inv_camera[3][1], inv_camera[3][2]);
}
